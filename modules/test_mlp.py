...
def data_loader():
    # 讀取資料集
    data = np.loadtxt(r'C:\Users\User\Desktop\NN\HW\HW1\NCU-NN-HW1\data\extra\IRIS.TXT')
    print("Loaded data:\n", data)
...
if __name__ == '__main__':
    ...
    # 填充訓練集顏色區域
    # ax[0].contourf(xx, yy, Z, alpha=0.8, cmap=ListedColormap(['lightblue', 'orange']))
    ...
    # 填充測試集顏色區域
    # ax[1].contourf(xx, yy, Z, alpha=0.8, cmap=ListedColormap(['lightblue', 'orange']))
